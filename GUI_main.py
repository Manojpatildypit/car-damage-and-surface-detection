...
image2 = image2.resize((2200,1000))
...
#
label_l1 = tk.Label(root, text="CAR DAMAGE",font=("Times New Roman", 35, 'bold'),
...
button3 = tk.Button(root, text="Exit",command=window,width=15, height=1,font=('times', 20, ' bold '), bg="#994d00", fg="white")
button3.place(x=100, y=399)
