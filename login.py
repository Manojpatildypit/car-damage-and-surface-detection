...
class main:
 ...
 # , relwidth=1, relheight=1)
    ...
    def widgets(self):
        ...
        # self.head.pack()
        # self.head = Label(self.master, text='LOGIN',background="brown", font=('Times New Roman', 35), pady=10)
        # self.head.pack()
        self.logf = tk.Frame(self.master, padx=50, pady=20, background="#0000FF")
        tk.Label(self.logf, text='Username: ', background="LavenderBlush", font=("Times New Roman", 20), pady=6,
                 padx=5).grid(sticky=tk.W)
        tk.Entry(self.logf, textvariable=self.username, bd=5, background="#ffeee6", font=('', 15)).grid(row=0, column=1)
        tk.Label(self.logf, text='Password: ', background="LavenderBlush", font=("Times New Roman", 20), pady=6,
                 padx=5).grid(sticky=tk.W)
        ...
        tk.Button(self.logf, text=' Login ', command=self.login, bd=2, font=("Times New Roman", 20), background="Red",
                  foreground="white", padx=2, pady=2).grid(rowspan=12,columnspan=12)
